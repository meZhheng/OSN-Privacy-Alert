...
class Mysql:
  ...
  def tweet_insert(self, item):
    # SQL 插入语句
    sql = "INSERT INTO tweets (tweet_id, time, replies, retweets, likes, views, text, image) " \
          "VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
    val = [["9999999999999999195", "2023.05.12", 10, 9, 8, 7, "这是一个多条插入测试2", "图片url"],
           ["9999999999999999294", "2023.05.12", 10, 9, 8, 7, "这是一个多条插入测试3", "图片url"]]
    # 执行 SQL 插入语句
